...
screen wardrobe_grid:
    ...
    add "interface/wardrobe_grid/scroll_grid_back.png"
    ...
    imagemap:
        ...
        if wardrobe_grid_tab == 1:
            ...
            text war_grid_txt[0] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 2:
            ...
            text war_grid_txt[1] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 3:
            ...
            text war_grid_txt[2] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 4:
            ...
            text war_grid_txt[3] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 5:
            ...
            text war_grid_txt[4] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 6:
            ...
            text war_grid_txt[5] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 7:
            ...
            text war_grid_txt[6] xalign 0.5 xpos 208 ypos 96 size 18
        else:
        ...
        if wardrobe_grid_tab == 8:
            ...
            text war_grid_txt[7] xalign 0.5 xpos 208 ypos 96 size 18
        else:
